...
<?php $__env->startSection('content'); ?>
    ...
    <p class="time">發佈日期：<?php echo e($news->release_at->format('Y')); ?>-<?php echo e($news->release_at->format('d')); ?>-<?php echo e($news->release_at->format('m')); ?></p>
    <div class="fluid">
        <h1 class="news-title"><?php echo e($news->title); ?></h1>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('web::layout', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Users/mac-2312-r/workspace/wwwroot/纤体-減肥/xenical-store/xenical-store-v1/resources/views/web/news/show.blade.php ENDPATH**/ ?>