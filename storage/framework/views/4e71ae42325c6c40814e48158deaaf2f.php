...
<?php $__env->startSection('content'); ?>
    ...
    <p class="en-title"><?php echo app('cache.config')->get('page_check_title_en'); ?></p>
    <h1 class="page-title"><?php echo app('cache.config')->get('page_check_title'); ?></h1>

    <div class="main">
        <p class="desc"><?php echo app('cache.config')->get('page_check_desc'); ?></p>
        <form action="" id="check-form" method="post" onsubmit="return orderCheck()">
            <?php echo e(csrf_field()); ?>

            <div class="form-group">
                <label for="phone">訂單行動電話：</label>
                <input class="form-control" type="tel" id="phone" name="phone" autocomplete="tel" placeholder="請輸入訂購时留下的電話號碼" required>
            </div>
            <div class="form-group">
                <label for="email">訂單電子郵箱：</label>
                <input class="form-control" type="email" id="email" name="email" autocomplete="email" placeholder="請輸入聯絡你的電話號碼" required>
            </div>
            <div class="form-group">
...
<?php echo $__env->make('web::layout', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Users/mac-2312-r/workspace/wwwroot/纤体-減肥/xenical-store/xenical-store-v1/resources/views/web/order/check.blade.php ENDPATH**/ ?>