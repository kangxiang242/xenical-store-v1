...
@section('content')
    ...
    <div class="top-fixed">
        <div class="order">
            ...
            <button class="submit-btn" onclick="$('#order-form').submit()"  data-observer="提交訂單按鈕">提交訂單</button>
        </div>
    </div>
                        ...
                        <div class="product-main">
                            ...
                            <div class="census">
                                <div class="compute">
                                    ...
                                    <dl>
                                        <dt>
                                            <p class="p-title">運費<span class="grep">（購買套裝可享受官方免費配送服務）</span></p>
                                        <!--  <p class="p-text">購買套裝可享受官方免運費服務</p> -->
                                        </dt>
                                        <dd>
                    ...
                    <div class="card">
                        ...
                        <div class="mater">
                            <div class="form-group">
                                <input class="form-control" data-validate="required:請問如何稱呼您" type="text" name="name" id="name">
                                <label class="shut" for="name">請問如何稱呼您</label>
                            </div>
                            <div class="form-group">
                                <input class="form-control" data-validate="required:請留下您收貨時使用的電話號碼|mobile:請留下正確的電話號碼" type="tel" name="phone" id="phone" maxlength="10" inputmode="numeric" oninput="this.value=this.value.replace(/[^0-9]/g,'')" pattern="^09\d{8}$" title="請輸入09開頭的10位數字">
                                <label class="shut" for="phone">請留下您收貨時使用的電話號碼</label>
                            </div>
                            <div class="form-group">
                                <input class="form-control" data-validate="required:請預留您的電子郵箱|email:請留下正確的電子郵箱" type="email" name="email" id="email">
