...
@section('content')
    ...
    <p class="en-title">{!! app('cache.config')->get('page_check_title_en') !!}</p>
    <h1 class="page-title">{!! app('cache.config')->get('page_check_title') !!}</h1>
    <div class="main">
        ...
        <form action="" id="check-form" method="post">
            ...
            <div class="form-group">
                ...
                <input class="form-control" type="tel" data-validate="required:請輸入你的订单電話|mobile:電話格式錯誤" id="phone" name="phone" autocomplete="tel" placeholder="請輸入訂購时留下的電話號碼" required>
            </div>
            <div class="form-group">
                <label for="email">訂單郵箱：</label>
                <input class="form-control" id="email" name="email" autocomplete="email" data-validate="required:請輸入订单電子郵箱|email:電子郵箱格式錯誤" name="email" placeholder="請輸入訂購时留下的電子郵箱" required>
            </div>
            <div class="form-group">
                <label for="captcha_code">安全驗證：</label>
                <div class="inline">
                    <input class="form-control captcha_code" data-validate="required:請輸入驗證碼" type="text" id="captcha_code" autocomplete="off" name="captcha_code" placeholder="請輸入驗證碼">
